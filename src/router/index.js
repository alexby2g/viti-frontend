...
export default defineRouter(({ store }) => {
  ...
  router.addRoute({ path:'/solicitar/:token', component:() => import('../layouts/AuthLayout.vue'), children:[{ path:'', name:'public-request', component:() => import('../pages/IdeaBuilderPage.vue') }] })
