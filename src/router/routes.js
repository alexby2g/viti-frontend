...
const electroHomePage = () => import('../pages/ElectrofrioInicioPage.vue')
const electroAgendaPage = () => import('../pages/ElectrofrioAgendaPage.vue')
const electroClientsPage = () => import('../pages/ElectrofrioClientesPage.vue')
...
export default [
  ...
  { path:'/apps/peluqueria', component:PeluqueriaAdminLayout, meta:{requiresAuth:true,adminOnly:true,appShell:'peluqueria-admin'}, children:[{path:'',name:'app-peluqueria',component:()=>import('../pages/PeluqueriaPage.vue'),meta:{requiresAuth:true,adminOnly:true,appShell:'peluqueria-admin'}}] },
  {
    path:'/mi-apps/electrofrio', component:ElectrofrioLayout, meta:{requiresAuth:true,clientOnly:true,appShell:'electrofrio'}, children:[
      ...
      {path:'inicio',name:'electro-client-home',component:electroHomePage,meta:{requiresAuth:true,clientOnly:true,appShell:'electrofrio',electroSection:'inicio'}},
      {path:'agenda',name:'electro-client-agenda',component:electroAgendaPage,meta:{requiresAuth:true,clientOnly:true,appShell:'electrofrio',electroSection:'agenda'}},
      ...
      {path:'clientes',name:'electro-client-clients',component:electroClientsPage,meta:{requiresAuth:true,clientOnly:true,appShell:'electrofrio',electroSection:'clientes'}},
  ...
  { path:'/apps/servicio-tecnico', component:SoporteVitalLayout, meta:{requiresAuth:true,adminOnly:true,appShell:'servicio-tecnico'}, children:supportChildren(false) },
  {
    path: '/', component: MainLayout, meta: { requiresAuth: true }, children: [
      ...
      { path: 'clientes/:id', name: 'cliente-detalle', component: () => import('../pages/ClienteDetallePage.vue'), meta:{adminOnly:true} },
      ...
      { path: 'solicitudes/:id', name: 'solicitud-detalle', component: () => import('../pages/SolicitudRevisionPage.vue'), meta:{adminOnly:true} },
      { path: 'trabajos', name: 'trabajos', component: () => import('../pages/ProyectosPage.vue'), meta:{adminOnly:true} },
      { path: 'trabajos/:id', name: 'trabajo-detalle', component: () => import('../pages/ProyectoDetallePage.vue'), meta:{adminOnly:true} },
      { path: 'proyectos', redirect: '/trabajos' },
      { path: 'proyectos/:id', redirect: to => `/trabajos/${to.params.id}` },
      { path: 'sistemas', name: 'sistemas', component: () => import('../pages/AplicacionesPage.vue'), meta:{adminOnly:true} },
      { path: 'sistemas/:id', name: 'sistema-detalle', component: () => import('../pages/SistemaDetallePage.vue'), meta:{adminOnly:true} },
      { path: 'aplicaciones', redirect: '/sistemas' },
      { path: 'apphub', redirect: '/sistemas' },
      ...
      { path: 'soporte', name: 'soporte', component: () => import('../pages/MantenimientosPage.vue'), meta:{adminOnly:true} },
      { path: 'mantenimientos', redirect: '/soporte' },
      ...
      { path: 'formularios-viti', name: 'formularios-viti', component: () => import('../pages/FormulariosVitiPage.vue'), meta:{adminOnly:true,superAdminOnly:true} },
