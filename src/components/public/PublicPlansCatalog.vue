...
<style scoped>
.catalog-head{display:flex;justify-content:space-between;gap:30px;align-items:end;margin-bottom:30px}.section-kicker,.price-label{font-size:11px;font-weight:900;letter-spacing:.13em;text-transform:uppercase;color:#f28b30}.catalog-head h2{font-size:clamp(30px,4vw,48px);line-height:1.05;letter-spacing:-.04em;margin:10px 0;color:#f6faff}.catalog-head p{color:#a9bac8;font-size:16px;line-height:1.6;max-width:720px}.catalog-switch{display:flex;justify-content:center;margin-bottom:25px}.catalog-loading{min-height:160px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;color:#94a8ba}.catalog-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}.plan-card{height:100%;border-radius:20px;background:linear-gradient(180deg,#0a192a,#10243c)!important;color:#eaf0f7!important;border:1px solid rgba(73,108,142,.34);box-shadow:0 16px 38px rgba(0,0,0,.16);transition:.2s ease}.plan-card:hover{transform:translateY(-3px);border-color:rgba(242,139,48,.44)}.featured-plan{background:linear-gradient(180deg,#10253f,#153256)!important;border:1px solid #f28b30;box-shadow:0 20px 55px rgba(0,0,0,.22)}.plan-body{height:100%;display:flex;flex-direction:column;padding:20px}.plan-top{display:flex;align-items:flex-start;gap:10px;justify-content:space-between}.plan-name{font-size:20px;font-weight:850;line-height:1.12}.plan-cap{font-size:11px;color:#91a6b9;margin-top:4px}.plan-description{min-height:88px;line-height:1.55;color:#b5c3cf;margin:15px 0 16px;font-size:13px;display:-webkit-box;-webkit-line-clamp:4;-webkit-box-orient:vertical;overflow:hidden}.price-value{font-size:28px;font-weight:900;line-height:1.05;margin-top:5px}.price-period{font-size:12px;color:#9eb0c0}.price-note{color:#8fa3b5;font-size:11px;line-height:1.5;margin-top:5px}.saving-chip{display:inline-block;margin-top:8px;padding:5px 9px;border-radius:999px;background:rgba(242,139,48,.12);color:#ffb067;font-size:10px;font-weight:800}.plan-card :deep(.q-separator){background:rgba(157,178,198,.16)}.simple-features{display:grid;gap:6px;margin:16px 0;color:#ccd7e1;font-size:11.5px}.simple-features>div{display:flex;gap:8px;align-items:flex-start}.simple-features .q-icon{color:#55d58f;font-size:17px;margin-top:-1px}.plan-action{margin-top:auto;min-height:44px;border-radius:12px}.catalog-note{margin-top:18px;padding:12px 15px;border-radius:13px;background:rgba(10,23,39,.9);color:#aebfcd;display:flex;gap:9px;align-items:center;font-size:11px;border:1px solid rgba(242,139,48,.18)}.catalog-note .q-icon{color:#f28b30}@media(max-width:1050px){.catalog-grid{grid-template-columns:repeat(2,1fr)}.plan-description{min-height:80px}}@media(max-width:650px){.catalog-head{flex-direction:column;align-items:flex-start}.catalog-grid{grid-template-columns:1fr}.plan-description{min-height:0}}
</style>
