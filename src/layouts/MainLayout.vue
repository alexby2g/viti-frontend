...
const menu=computed(()=>{
  ...
  const operational = [
    ...
    {label:'Atención',icon:'forum',children:[{label:'Buzón de clientes',icon:'mark_chat_unread',to:'/buzon',badge:notifications.unreadCount},{label:'Casos de soporte',icon:'build_circle',to:'/mantenimientos'}]},
    {label:'Archivos',icon:'folder',children:[{label:'Archivos de clientes',icon:'folder_shared',to:'/archivos'}]},
