...
const menu=computed(()=>{
  if(isClient.value){
    ...
    items.push({label:'Mi negocio',icon:'storefront',to:'/mi-negocio'},{label:'Aplicaciones',icon:'apps',children:[{label:'Instaladas',icon:'grid_view',to:'/mi-aplicaciones'}]})
  ...
  if(isSuperAdmin.value){
    ...
    operational.push({label:'Administración',icon:'admin_panel_settings',children:[{label:'Usuarios',icon:'manage_accounts',to:'/usuarios'},{label:'Auditoría',icon:'history',to:'/auditoria'}]})
  }
  return operational
})
