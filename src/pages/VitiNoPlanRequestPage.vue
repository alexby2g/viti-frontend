    ...
    <div class="q-mx-auto" style="max-width: 980px">
      <q-card flat bordered class="q-pa-lg">
        ...
        <div class="text-body1 text-grey-7 q-mb-lg">
          Puedes completar el cuestionario sin seleccionar todavía un plan de pago. Después de revisar tus respuestas, VITI puede recomendar la configuración y el plan adecuados.
        </div>
        ...
        <div v-if="apiUnavailable" class="q-py-xl text-center">
          ...
          <div class="text-body2 text-grey-7 q-mt-sm q-mb-lg">
            Render puede estar iniciando la instancia o todavía no tener desplegado el endpoint de evaluación.
          </div>
        ...
        <div v-else-if="submitted" class="text-center q-py-xl">
          ...
          <div class="text-body2 text-grey-6 q-mt-sm">Tu solicitud quedó en revisión sin plan seleccionado.</div>
        </div>
